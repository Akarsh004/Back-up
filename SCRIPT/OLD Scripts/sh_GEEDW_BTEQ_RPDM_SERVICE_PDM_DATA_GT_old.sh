...
INSERT INTO GEEDW_PLP_BULK_T.MT_RPDM_T2SYSTEM_INSTANCE_GT
(
SYSTEM_NM
,LVL
,REL_TYPE
...
WITH RECURSIVE HIER (T2SPUNAME,LVL,REL_TYPE,ITEM_IDNFR,CLASS_NM,PARTNUMBER,TEXTM,CREATION_DATE,REMARKM,REV_INDEX,SEQUENCE,PROJECTNAME
...
SELECT  
T2SPUNAME,LVL,REL_TYPE,ITEM_IDNFR,PARTNUMBER,TEXTM,CREATION_DATE,REMARKM,CLASS_NM,REV_INDEX,SEQUENCE
