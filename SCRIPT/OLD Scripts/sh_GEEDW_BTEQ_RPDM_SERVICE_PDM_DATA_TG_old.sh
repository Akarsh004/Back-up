# --------------------------------------------------------------------------------------------------------------#
# File: sh_GEEDW_BTEQ_RPDM_SERVICE_PDM_DATA_GT.sh										#
...
UPLOAD_FILE=/data/informatica/ETCOE/EEDW01/SrcFiles/RPDM_SYSTEM_NUMBERS_TG.DAT
export UPLOAD_FILE
date1=`date +%m/%d/%Y`
v_date="'$date1'"
...
collect stats column ( SYSTEM_NM ) on GEEDW_PLP_BULK_T.MT_RPDM_T2SYSTEM_INSTANCE_TG;
collect stats column ( T2SPUNUMBER ) on GEEDW_PLP_BULK_T.MT_RPDM_T2SYSTEM_INSTANCE_TG;

INSERT INTO GEEDW_PLP_BULK_T.MT_RPDM_T2SYSTEM_INSTANCE_TG
(
SYSTEM_ID
,SYSTEM_NM
,LVL
...
WITH RECURSIVE HIER (SYSTEM_ID,T2SPUNAME,LVL,REL_TYPE,ITEM_IDNFR,CLASS_NM,PARTNUMBER,TEXTM,CREATION_DATE,REMARKM,REV_INDEX,SEQUENCE,PROJECTNAME
...
--AND INSTNCE.PARTNUMBER  IN  ('INS001009764786')
UNION ALL 
...
SELECT  
SYSTEM_ID,T2SPUNAME,LVL,REL_TYPE,ITEM_IDNFR,PARTNUMBER,TEXTM,CREATION_DATE,REMARKM,CLASS_NM,REV_INDEX,SEQUENCE
