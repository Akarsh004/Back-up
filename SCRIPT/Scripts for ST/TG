# --------------------------------------------------------------------------------------------------------------#
# File: sh_GEEDW_BTEQ_RPDM_SERVICE_PDM_DATA_TG.sh								#
...
--DELETE FROM GEEDW_PLP_BULK_T.MT_RPDM_SYSTEM_INSTANCE_TG;

collect stats column ( T2SPUNAME ) on GEEDW_PLP_BULK_T.MT_RPDM_SYSTEM_INSTANCE_TG;
collect stats column ( PARTNUMBER ) on GEEDW_PLP_BULK_T.MT_RPDM_SYSTEM_INSTANCE_TG;
collect stats column ( CHILD_OBID ) on GEEDW_PLP_BULK_T.MT_RPDM_SYSTEM_INSTANCE_TG;

INSERT INTO GEEDW_PLP_BULK_T.MT_RPDM_SYSTEM_INSTANCE_TG
(
SYSTEM_ID
,T2SPUNAME
,PARENT_NM
