...
UPLOAD_FILE=/data/informatica/ETCOE/EEDW01/SrcFiles/RPDM_SYSTEM_NUMBERS_GT.DAT
export UPLOAD_FILE
date1=`date +%m/%d/%Y`
v_date="'$date1'"
...
--DELETE FROM GEEDW_PLP_BULK_T.MT_RPDM_SYSTEM_INSTANCE_GT;

collect stats column ( T2SPUNAME ) on GEEDW_PLP_BULK_T.MT_RPDM_SYSTEM_INSTANCE_GT;
collect stats column ( PARTNUMBER ) on GEEDW_PLP_BULK_T.MT_RPDM_SYSTEM_INSTANCE_GT;
collect stats column ( CHILD_OBID ) on GEEDW_PLP_BULK_T.MT_RPDM_SYSTEM_INSTANCE_GT;

INSERT INTO GEEDW_PLP_BULK_T.MT_RPDM_SYSTEM_INSTANCE_GT
(
SYSTEM_ID
,T2SPUNAME
,PARENT_NM
